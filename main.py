    ...
    def openNewWindow(self):
        def decrypt():
            ...
            if password == "1234":
                ...
                b2 = Button(screen2, text="Ok", height="2", width=25,  bg="#ECF0F1", fg="black", bd=0, cursor='hand2').place(x=100, y=150)
        ...
        def encrypt():
            ...
            if password == "1234":
                ...
                b1 = Button(screen1, text="Ok", height="2", width=25,  bg="#ECF0F1", fg="black", bd=0, cursor='hand2').place(x=100, y=150)
